  ...
  if (!slug) {
    return (
      <div className="min-h-screen bg-slate-950 text-slate-100 pb-24 selection:bg-purple-500/30 pt-24">
        ...
        <section className="max-w-6xl mx-auto px-6 mt-12 lg:grid grid-cols-3 items-start relative">
          <div className="flex flex-col sm:flex-row sm:items-center lg:sticky top-34 justify-between items-start gap-4 border-b border-slate-900 pb-6 mb-10">
